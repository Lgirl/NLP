...
def config_poem_train(args=''):
    ...
    #                     default='../poet_train_data/poem/poems_space.txt',
    #                     help='poet_train_data file')

    parser.add_argument('--data_path', type=str,
                        default='./poet_train_data/poem/',
                        help='poet_train_data path')


    parser.add_argument('--encoding', type=str,
                        default='utf-8',
                        help='the encoding of the poet_train_data file.')
    ...
    parser.add_argument('--cell_type', type=str, default='lstm',
                        help='which output_chat to use (rnn, lstm or gru).')
    ...
    parser.add_argument('--train_frac', type=float, default=0.9,
                        help='fraction of poet_train_data used for training.')
    parser.add_argument('--valid_frac', type=float, default=0.05,
                        help='fraction of poet_train_data used for validation.')
    ...
    # Parameters to feed in the initial output_chat and current best output_chat.
    parser.add_argument('--init_model', type=str,
                        default='', help=('initial output_chat'))
    parser.add_argument('--best_model', type=str,
                        default='', help=('current best output_chat'))
    ...
    parser.add_argument('--test', dest='test', action='store_true',
                        help=('use the first 1000 character to as poet_train_data to test the implementation'))
    parser.set_defaults(test=False)

    # input_args = '--data_path ./poet_train_data/poem --output_dir output_poem --hidden_size 256 --embedding_size 128 --num_unrollings 128 --debug --encoding utf-8'
...
def config_sample(args=''):
    ...
    logging_args.add_argument('--data_dir', type=str,
            default='./poet_train_data/poem',
            help='poet_train_data file path')
