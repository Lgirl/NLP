...
import numpy as np
from poet_py.word2vec_helper import Word2Vec
import math
...
class DataLoader():
    ...
    def _print_stats(self):
        print('Loaded {}:  training  chatBot_train_data:{} ,validationSamples:{},testingSamples:{}'.format(
    ...
    def load_from_text_file(self,in_file):
        # base_path = 'F:\BaiduYunDownload\chatbot_lecture\lecture2\poet_train_data\ice_and_fire_zh'
  ...
  # 3. utility 函数，使用pickle读文件
    ...
    def create_batches(self,samples):
        ...
        # x_lengths = [len(sample) for sample in chatBot_train_data]
        ...
        for i,sample in enumerate(samples):
            # fill with padding to align batchSize chatBot_train_data into one 2D list
...
if __name__ == '__main__':
    base_path = './poet_train_data/poem'
    ...
    # print("唐诗总数： %d"%len(poems))
    #
    # poem_ids = get_text_idx(poems,w2v.output_chat.vocab_hash,100)
