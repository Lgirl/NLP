...
from poet_py.char_rnn_model import CharRNNLM
from poet_py.data_loader import DataLoader
...
def main(args=''):
    ...
    args.save_best_model = os.path.join(args.output_dir, 'best_model/output_chat')
...
if __name__ == '__main__':
    args = '--output_dir output_poem --data_path ./poet_train_data/poem/  --hidden_size 128 --embedding_size 128 --cell_type lstm'
    main(args)
